...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/bimivalidator',
        'Source': 'https://github.com/apiverve/bimivalidator-api',
        'Bug Tracker': 'https://github.com/apiverve/bimivalidator-api/issues'
    },
    classifiers=[
