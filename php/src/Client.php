...
namespace APIVerve\Bimivalidator;
...
/**
 * Client for the BIMI Record Validator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/bimivalidator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/bimivalidator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BimivalidatorClient] {$message}\n";
        }
    }
}
