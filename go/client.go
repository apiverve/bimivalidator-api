...
const (
	baseURL        = "https://api.apiverve.com/v1/bimivalidator"
	defaultTimeout = 30 * time.Second
)

// Client is the BIMI Record Validator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new BIMI Record Validator API client.
...
// Execute makes a request to the BIMI Record Validator API with typed parameters.
//
