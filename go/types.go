// Package bimivalidator provides a Go client for the BIMI Record Validator API.
//
// For more information, visit: https://apiverve.com/marketplace/bimivalidator?utm_source=go&utm_medium=readme
package bimivalidator
...
// Request contains the parameters for the BIMI Record Validator API.
//
// Parameters:
//   - domain (required): string - The domain to validate the BIMI record for
type Request struct {
...
// ResponseData contains the data returned by the BIMI Record Validator API.
type ResponseData struct {
	BimiHost string `json:"bimi_host"`
	BimiRecord string `json:"bimi_record"`
	BimiRecordsCount int `json:"bimi_records_count"`
	HasBimiRecord bool `json:"has_bimi_record"`
	Host string `json:"host"`
	SvgLogo SvgLogoData `json:"svg_logo"`
	Valid bool `json:"valid"`
	Version string `json:"version"`
	VmcCertificate VmcCertificateData `json:"vmc_certificate"`
}

// SvgLogoData represents the svg_logo object.
type SvgLogoData struct {
...
// VmcCertificateData represents the vmc_certificate object.
type VmcCertificateData struct {
	StatusCode int `json:"status_code"`
	Url string `json:"url"`
	Valid bool `json:"valid"`
}
