# BIMI Record Validator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:bimivalidator-api:1.1.13'
}
```
...
```java
import com.apiverve.bimivalidator.BIMIRecordValidatorAPIClient;
import com.apiverve.bimivalidator.APIResponse;
import com.apiverve.bimivalidator.APIException;

// Initialize the client
BIMIRecordValidatorAPIClient client = new BIMIRecordValidatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/bimivalidator](https://docs.apiverve.com/ref/bimivalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/bimivalidator](https://docs.apiverve.com/ref/bimivalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/bimivalidator-api/issues)
